...
<span style="font-size:large;">please read this</span>

rewriting book, don't stress about it. this version of easypeasy works extremely well though.

I need your (anyone, from anywhere, with any voting status) for helping with meme magic for the Australian election.

our voting system is fair and means we can escape a two party system if everyone understands how it works and doesn't vote 1st preference for the major parties.

I reckon this will start a conversation about fair voting systems around the world.

you can help by:
- sharing the message online (discord, reddit)
- making memes and content with #votingAU #auspol so more people see it

it'll only takes a small amount of time and it'll set the world on a good path :o)

<span style="font-size:x-large;">link is: <https://voting.org.au/hey></span
