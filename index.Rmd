...
small notes from me, cheers mate.

Summarising, easypeasy genuinely works but is funnily written, haha, but I'm rewriting it and here's my [propoer prose](https://easypeasymethod.org/resources/principal.pdf)

PLEASE PLEASE PLEASE I need ***your*** help on two projects PLEASE:

 * <https://cafeculture.org> (*extremely* rough "but gets the job done and no time or interest learning webdev" and small cafe sustainability directory)
 * <https://preferences.org.au> publicise objective facts about the preferential voting system (HELPING INTERNATIONAL PEOPLE TOO (publicising preferential voting worldwide creating fairer governments, and also Australia will be able to help the world (please help us) )

Please, I beg for your help because Australia is stuck in a two party system for really no reason (because we have full run off preferential voting, so votes for a minor candidates are worth *much* more ('strategic voting' where you have to vote for one person over another *is impossible* because you have multiple votes easily): central message is **vote 1 [any minor party]**

* follow our socials (listed on the <https://preferences.org.au> website)
 + [discord](https://discord.gg/SvPaZYa9Dr)
 + [instagram](https://www.instagram.com/preferences.org.au/)
 + [youtube](https://www.youtube.com/channel/UChMZhvS7eV-WoLDu_mRjEEw)
 + [twitter](https://twitter.com/preferencesAU)
 + [facebook](https://www.facebook.com/preferences.org.au/)
 + [tiktok](https://www.tiktok.com/@preferences.org.au)
* post stuff online about <https://preferences.org.au>
* tune into our [twitch streams](https://twitch.tv/fraserpatterson) where we walk around Perth, Western Australia and ask people about [any minor party]
* there's also highlights posted on my [youtube](https://www.youtube.com/channel/UChMZhvS7eV-WoLDu_mRjEEw) as well.
