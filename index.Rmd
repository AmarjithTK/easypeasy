...
rewriting book, don't stress about it, this version of easypeasy works well.

I need your (anyone, from anywhere, with any voting status) help with meme magic for the Australian election.

our preferential voting system means we can escape a two party system if everyone understands how it works.

I reckon this will start a conversation about fair voting systems around the world.

you can help by:

* sharing the message online (discord, reddit and more)
