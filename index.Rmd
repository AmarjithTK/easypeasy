...
I'm Fraser, and I live in Australia. Our government [continues supporting fossil fuels](https://www.abc.net.au/news/2021-10-22/greenpeace-australia-ipcc-pressure/100558890), [mismanages bushfires](https://www.theguardian.com/australia-news/2020/jun/03/australian-bushfires-fois-shed-new-light-on-why-morrison-government-was-ill-prepared), all allongside [many corruption scandals](https://en.wikipedia.org/wiki/List_of_political_controversies_in_Australia#Morrison_government).


Since Australia became a country, we've mostly had [only two parties in power](https://en.wikipedia.org/wiki/List_of_Australian_federal_elections). . Since Australia's voting system is preferential, voting for smaller parties (who might not win) gives you heaps more votes. 

However, most people vote [1] for the major parties, meaning that Australia is stuck in a two party system for really no reason.
...
knitr::include_url("https://docs.google.com/forms/d/e/1FAIpQLSdcGuEWxy02Ue59GDiKzkkND8wR_U7dieLINb5oo5WGDH3JpA/viewform?embedded=true")
