...
```
[video](https://youtu.be/Jiq3BB2QDFQ) summary: easypeasy works but funny written haha (am rewriting - see [my actual writing here](https://easypeasymethod.org/resources/principal.pdf)) // need your help on ***two projects*** PLEASE: <https://cafeculture.org> (worldwide sustainable cafes directory) // <https://preferences.org.au> - meme magic for Australian election (WILL HELP INTERNATIONAL PEOPLE TOO (publicising preferential voting worldwide fairer governments)

Please, I could really use your help because Australia is stuck in a two party system for really no reason (because we have full run off preferential voting, so votes for a minor candidates are worth *much* more: central message is **vote 1 [any minor party]**
...
**this entire section usually isn't here** but this is really important to me so thank you for reading :o)
